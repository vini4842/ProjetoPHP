                ...
                <div class="row text-center pad-top">    
                 ...
                 <div class="col-lg-12 col-md-6">
                        ...
                        <form method="POST" action="validacaoCursoCRUD.php" class="form-horizontal"  enctype="multipart/form-data">
							...
							<input name="adiciona" type="submit" class="btn btn-success" value="Adicionar"/> | <input type="reset" class="btn btn-warning" value="Limpar"/> | <a href="curso.php" class="btn btn-danger"> Cancelar </a>
							</fieldset>
						</form>
